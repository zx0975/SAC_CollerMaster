...
class Test(core.Env):
    ACTION_VEC_TRANS = 1/3600
    ACTION_ORI_TRANS = 1/1200
    ACTION_PHI_TRANS = 1/1200
    ...
    def get_reward(self, s, ik_success, terminal, singularity):
        ...
        # reward -= (self.max_force/300)*1/4
        # reward -= (self.max_torque/30)*1/4
        # reward -= (self.dis_z*30)*1/4
        # reward -= (self.delta_z*30)*1/4
        # reward -= (self.dis_pos*30)*1/2
        # reward -= (self.dis_ori*10)*1/2
