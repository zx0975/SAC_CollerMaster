...
class Test(core.Env):
    ACTION_VEC_TRANS = 1/30000*4
    ACTION_ORI_TRANS = 1/10000*4
    ACTION_PHI_TRANS = 1/10000*4
    ...
    def step(self, a):      
        ...
        self.state = s
        fail = False
        if self.max_force > 300 or self.max_torque > 30 or self.dis_x  > 0.04 or self.dis_y > 0.04 or self.dis_pos > 0.05:
            fail = True
        ...
        #     Fx.write(str(self.sensor_array[0]))
        #     Fx.write('\n')
        # with open("test_Fy.txt","a") as Fy:
        #     Fy.write(str(self.sensor_array[1]))
        #     Fy.write('\n')
        # with open("test_Fz.txt","a") as Fz:
        #     Fz.write(str(self.sensor_array[2]))
        #     Fz.write('\n')
        # with open("test_M.txt","a") as M:
        #     M.write(str(self.max_torque))
        #     M.write('\n')
        # with open("test_Mx.txt","a") as My:
        #     My.write(str(self.sensor_array[3]))
        #     My.write('\n')
        # with open("test_My.txt","a") as My:
        #     My.write(str(self.sensor_array[4]))
        #     My.write('\n')
        # with open("test_Mz.txt","a") as Mz:
        #     Mz.write(str(self.sensor_array[5]))
        #     Mz.write('\n')
        
        return self.state, terminal, res.success, res.singularity, fail
