...
import random
NAME = 'SAC_v17_32'
# SAC_v17_7 is ex_step 300 ACTION 1800 action 8 state 14 success_cnt > 0 goal_err 0.005
# SAC_v17_8 is ex_step 300 ACTION 2400 action 8 state 14 success_cnt > 0 goal_err 0.005 workers 16
# SAC_v17_9 is ex_step 300 ACTION 2400 action 8 state 14 success_cnt > 0 goal_err 0.005 workers 4
# SAC_v17_10 is ex_step 300 ACTION 2400 action 8 state 14 success_cnt > 0 goal_err 0.005 workers 4 force torque reset
# SAC_v17_11 is ex_step 300 ACTION 2400 action 8 state 14 success_cnt > 0 goal_err 0.005 workers 4 force torque reset force-=11.898
# SAC_v17_12 is ex_step 300 ACTION 2400 action 8 state 14 success_cnt > 0 goal_err 0.005 workers 8 force torque reset force-=11.898
# SAC_v17_13 is ex_step 400 ACTION 2400 action 8 state 14 success_cnt > 0 goal_err 0.005 workers 8 force torque reset force-=11.898 512->256
# SAC_v17_14 is ex_step 400 ACTION 2400 action 8 state 27
# SAC_v17_15 is ex_step 400 ACTION 2400 action 8 state 27 goal_err 0.008
# SAC_v17_16 is ex_step 400 ACTION 2400 action 8 state 27 goal_err 0.008 1e-4 -dz
# SAC_v17_17 is ex_step 600 ACTION 2400 action 8 state 27 goal_err 0.008 1e-4 -dz 256->512
# SAC_v17_18 is ex_step 800 ACTION 2400 action 8 state 27 goal_err 0.008 1e-4 -dz 256->512 success_reward
# SAC_v17_19 is ex_step 600 ACTION 2400 action 8 state 27 goal_err 0.008 1e-4 -dz 256->512 success_reward
# SAC_v17_20 is ex_step 600 ACTION 2400 action 8 state 27 goal_err 0.008 1e-4 -dz 256->512 success_reward+= hole_v5
# SAC_v17_21 is ex_step 600 ACTION 2400 action 8 state 27 goal_err 0.008 1e-4 256->512 success_reward+= hole_v5 -dz*2
# SAC_v17_22 is ex_step 600 ACTION 2400 goal_err 0.02 1e-3
# SAC_v17_23 is ex_step 800 ACTION 3600
# SAC_v17_24 is ex_step 600 ACTION 3000
# SAC_v17_25 is ex_step 600 ACTION 3000 4*workers success_reward= -dz*3
# SAC_v17_26 is ex_step 600 ACTION 3000 10*workers success_reward= -dz*3
# SAC_v17_26 is ex_step 600 ACTION 3000 12*workers success_reward= -dz*3
# SAC_v17_27 is ex_step 600 ACTION 3000 12*workers success_reward= -dz*3 progressive(X)
# SAC_v17_28 is ex_step 600 ACTION 3000 12*workers success_reward= -dz*3 goal_err 0.01 ori_err 0.2
# SAC_v17_29 is progressive 6*workers -dz*30
# SAC_v17_30 is progressive 6*workers -dz*30 fail
# SAC_v17_31 is
# SAC_v17_32 is ori_err = 0.1
EPS = 1e-8
LOAD = False
BATCH_SIZE = 512
SEED = [123, 321]
...
class SAC(object):
    def __init__(self, act_dim, obs_dim, lr_actor, lr_value, gamma, tau, buffers, alpha=0.2, name=None, seed=1):
        ...
        self.writer = tf.summary.FileWriter('/home/chi/SAC_0420/src/Collision_Avoidance/train/logs/'+NAME+'/'+self.name+'/', self.sess.graph)
        self.saver = tf.train.Saver()
        self.path = '/home/chi/SAC_0420/src/Collision_Avoidance/train/weights/'+ NAME +'/'+ self.name
